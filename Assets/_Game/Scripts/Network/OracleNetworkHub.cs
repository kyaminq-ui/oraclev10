...
public class OracleNetworkHub : MonoBehaviourPunCallbacks
{
    ...
    [Tooltip("Si faux, ne rejoint pas automatiquement une room après la connexion (utile dans le hub pour rester en lobby).")]
    public bool autoJoinRoomOnConnect = true;
    ...
    public override void OnConnectedToMaster()
    {
        ...
        if (autoConnectOnStart && autoJoinRoomOnConnect)
            JoinOrCreateQuickMatchRoom();
    }
