...
public class TurnManager : MonoBehaviour
{
    ...
    public IReadOnlyList<TacticalCharacter> TurnOrder => turnOrder;
    public int GetTeamId(TacticalCharacter ch) =>
        characterTeams.TryGetValue(ch, out int t) ? t : -1;
    ...
    public void EndTurn()
    {
        ...
        if (GridManager.Instance != null)
            GridManager.Instance.TickTemporaryWalls();
