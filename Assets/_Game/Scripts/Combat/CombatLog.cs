...
{
    /// <summary>Messages de log de combat (effets de sort, etc.).</summary>
    public static event Action<string> OnMessage;

    /// <summary>Messages de chat joueur : (nomJoueur, texte).</summary>
    ...
    /// <summary>Diffuse un message de chat émis par un joueur.</summary>
    public static void AppendChat(string sender, string message)
    {
        if (string.IsNullOrEmpty(message)) return;
