...
public static class OracleMinimalistUIRebuild
{
    ...
    static void RebuildPassiveScreen()
    {
        ...
        timerCornerRT.sizeDelta        = new Vector2(80f, 80f);
        ...
        Stretch(ttRT);
        pss.timerText = Tmp(ttRT.gameObject, "30", 26f, FontStyles.Bold, C_GOLD, TextAlignmentOptions.Center);
    ...
    static void RebuildCombatHUD()
    {
        ...
        // HP track (zone icône animée HP + texte centré comme PA/PM)
        var pTrackRT = AnchoredRect(topRT.transform, "PlayerHpTrack",
            ancMin: new Vector2(0f, 1f), ancMax: new Vector2(0.28f, 1f),
            pivot:  new Vector2(0f, 1f),
            pos:    new Vector2(16f, -30f), size: new Vector2(-32f, 56f));
        ...
        var pFillRT = AnchoredRect(pTrackRT.transform, "Fill",
            ...
            pos:    Vector2.zero, size: new Vector2(56f, 56f));
        var pFill           = pFillRT.gameObject.AddComponent<Image>();
        pFill.color         = Color.white;
        pFill.type          = Image.Type.Simple;
        pFill.preserveAspect = true;
        pFill.fillAmount    = 1f;
        hud.teamAHpFill     = pFill;
        var pHpAnim = pFill.gameObject.AddComponent<HudAnimatedStatIcon>();
        pHpAnim.resourcesFolder = "OracleHUD/Frames/animated_hp_icon";
        pHpAnim.fps = 10f;
        pHpAnim.RefreshFrames();

        // HP value (réparent par CombatHUD sur l’icône au runtime)
        var pValRT = AnchoredRect(topRT.transform, "PlayerHpValue",
            ancMin: new Vector2(0f, 1f), ancMax: new Vector2(0.28f, 1f),
            pivot:  new Vector2(0f, 1f),
            pos:    new Vector2(16f, -42f), size: new Vector2(0f, 18f));
        hud.teamAHpValue = Tmp(pValRT.gameObject, "50", 12f, FontStyles.Normal, C_TEXT_WHITE, TextAlignmentOptions.Left);
        ...
        var timerHostRT = AnchoredRect(rootGO.transform, "TimerHost",
            ...
            pivot:  new Vector2(0.5f, 1f),
            pos:    new Vector2(0f, -10f), size: new Vector2(80f, 80f));
        ...
        oFill.color         = new Color(0.91f, 0.28f, 0.33f, 1f);
        oFill.type          = Image.Type.Simple;
        oFill.preserveAspect = true;
        oFill.fillAmount    = 1f;
        hud.teamBHpFill     = oFill;
        var oHpAnim = oFill.gameObject.AddComponent<HudAnimatedStatIcon>();
        oHpAnim.resourcesFolder = "OracleHUD/Frames/animated_hp_icon";
        oHpAnim.fps = 10f;
        oHpAnim.RefreshFrames();

        var oValRT = AnchoredRect(topRT.transform, "OpponentHpValue",
            ancMin: new Vector2(0.72f, 1f), ancMax: new Vector2(1f, 1f),
            pivot:  new Vector2(1f, 1f),
            pos:    new Vector2(-16f, -42f), size: new Vector2(0f, 18f));
        hud.teamBHpValue = Tmp(oValRT.gameObject, "50", 12f, FontStyles.Normal, C_TEXT_WHITE, TextAlignmentOptions.Right);
        ...
        var endWrapRT = AnchoredRect(botRT.transform, "EndTurnWrap",
            ancMin: new Vector2(1f, 0.5f), ancMax: new Vector2(1f, 0.5f),
            pivot:  new Vector2(1f, 0.5f),
            pos:    new Vector2(-16f, 0f), size: new Vector2(156f, 64f));
        ...
        var endTurnAnim = endWrapRT.gameObject.AddComponent<HudEndTurnAnimatedButton>();
        endTurnAnim.resourcesFolder   = "OracleHUD/Frames/end_turn_animated_button";
        endTurnAnim.hideTMPChildren = true;
        endTurnAnim.fps             = 12f;
        endTurnAnim.RefreshFrames();
