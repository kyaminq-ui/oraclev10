...
public class GridConfig : ScriptableObject
{
    ...
    [Tooltip("[OBSOLÈTE] Ce biais n'est plus utilisé par UpdateSortingOrder.\n" +
             "Le tri isométrique des personnages est désormais aligné sur la formule obstacle (baseOrder + w*h).")]
